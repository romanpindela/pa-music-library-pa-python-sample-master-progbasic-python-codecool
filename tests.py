...
from music_reports import get_albums_by_genre, get_genre_stats,\
    ...
    get_albums_by_year, get_oldest_album, get_oldest_of_genre, get_total_albums_length
...
class BasicTestCase(unittest.TestCase):
    ...
    def test_get_albums_by_year(self):
        ...
        albums = get_albums_by_year(self.albums, '2010')
    ...
    def test_get_oldest_album(self):
        ...
        oldest = get_oldest_album(self.albums)
    ...
    def test_get_oldest_of_genre(self):
        ...
        oldest = get_oldest_of_genre(self.albums, "hard rock")
